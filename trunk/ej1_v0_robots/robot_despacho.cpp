...
void ValidarArgumentos( int argc, char** argv ){
      if( argc < 2 ){
            MensajeError( Robots::Constantes::NOMBRE_PROCESO_ROBOT_DESPACHO, "Faltan parametros. Uso: %s <numRobot>", argv[0] );
            exit(-1);
      }
}
...
int main( int argc, char** argv ){
      ...
      string nombreProceso = Robots::Constantes::NOMBRE_PROCESO_ROBOT_DESPACHO + string( argv[1] );
